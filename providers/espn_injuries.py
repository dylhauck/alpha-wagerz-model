...
def parse_official_status(
    ...
    if (
        "injured list" in value
        or "disabled list" in value
    ):
        return "Injured List"
...
def estimated_return_from_transaction(
    ...
    if il_days and effective:
        try:
            ...
            eligible = (
                start
                + timedelta(days=il_days)
            )

            return (
                f"Eligible "
                f"{format_date(eligible)}"
            )
    ...
    for team in teams:
        ...
        for transaction in transactions:
            ...
            active[key] = {
                ...
                "estimated_return": (
                    estimated_return_from_transaction(
                        transaction,
                        description,
                        type_desc,
                    )
